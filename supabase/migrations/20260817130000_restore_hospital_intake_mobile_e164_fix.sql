-- The doctor_name migration (20260817120000) was written by copying the
-- original create_hospital_medicine_course body instead of the version
-- already fixed by 20260814070000, so `create or replace function`
-- silently reverted that earlier fix: mobile numbers went back to being
-- stored bare (e.g. "9866531011") instead of +91-prefixed E.164
-- ("+919866531011"), the format every other patient lookup in the app
-- uses. This restores the +91 prefixing while keeping doctor_name.
