...
const translations = {
  en: {
    ...
    deliveryAddresses: 'Manage Address',
    hospital: 'Hospital',
    imaging: 'Imaging',
    ...
    camps: 'Camps',
    campsTitle: 'Free Camps',
    campsSubtitle: 'Free medical and dental camps from your hospitals',
    campsEmpty: 'No camps on this day. Check another date.',
    campMedical: 'Medical Camp',
    campDental: 'Dental Camp',
    campOther: 'Health Camp',
    campRegister: 'Register',
    campRegistered: 'Booked',
    campShift: 'Shift',
    campRegisterFailed: 'Could not register. Try again.',
    language: 'Language',
    logOut: 'Log out',
  ...
  te: {
    ...
    deliveryAddresses: 'చిరునామాను నిర్వహించండి',
    hospital: 'ఆసుపత్రి',
    imaging: 'ఇమేజింగ్',
    ...
    camps: 'క్యాంపులు',
    campsTitle: 'ఉచిత క్యాంపులు',
    campsSubtitle: 'మీ ఆసుపత్రుల నుండి ఉచిత వైద్య మరియు దంత శిబిరాలు',
    campsEmpty: 'ఈ రోజు క్యాంపులు లేవు. వేరే తేదీని ఎంచుకోండి.',
    campMedical: 'వైద్య శిబిరం',
    campDental: 'దంత శిబిరం',
    campOther: 'ఆరోగ్య శిబిరం',
    campRegister: 'నమోదు చేసుకోండి',
    campRegistered: 'బుక్ అయ్యింది',
    campShift: 'మార్చు',
    campRegisterFailed: 'నమోదు చేయలేకపోయాము. మళ్లీ ప్రయత్నించండి.',
    language: 'భాష',
    logOut: 'లాగ్ అవుట్',
